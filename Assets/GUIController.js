...
//		} TODO: OLD JOURNAL DISPLAY
	...
	if (tm.interacting) {
        ...
        if (quiz) {
            ...
            GUI.Box(Rect(Screen.width/4,Screen.height/4.25-10,Screen.width/1.75,Screen.height/1.5+10), "");
            GUI.Box(Rect(Screen.width/4,Screen.height/4.25-10,Screen.width/1.75,Screen.height/1.5+10), "");
            GUI.Label(Rect(Screen.width/4+5,Screen.height/4.25-5,Screen.width/2,Screen.height/2), "Use arrow keys to move and select answer with the spacebar.", quizAnswerStyle);
